...
oe_result_t helloworld_initialize_enclave(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    initialize_enclave_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    OE_ADD_SIZE(_input_buffer_size, sizeof(initialize_enclave_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(initialize_enclave_args_t));
    /* There were no corresponding parameters. */
    ...
    _pargs_in = (initialize_enclave_args_t*)_input_buffer;
...
>>>>>>> Stashed changes
    ...
    _pargs_out = (initialize_enclave_args_t*)_output_buffer;
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __helloworld_ecall_info_table[helloworld_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* report_buffer_size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __helloworld_ecall_info_table[helloworld_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __helloworld_ecall_info_table[helloworld_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __helloworld_ecall_info_table[helloworld_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_enclave_worker_context_t* context)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __helloworld_ecall_info_table[helloworld_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    connect_args_t* pargs_in = (connect_args_t*)input_buffer;
    connect_args_t* pargs_out = (connect_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    request_args_t* pargs_in = (request_args_t*)input_buffer;
    request_args_t* pargs_out = (request_args_t*)output_buffer;
...
static void ocall_get_response(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    get_response_args_t* pargs_in = (get_response_args_t*)input_buffer;
    get_response_args_t* pargs_out = (get_response_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    close_args_t* pargs_in = (close_args_t*)input_buffer;
    close_args_t* pargs_out = (close_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    oe_syscall_ftruncate_ocall_args_t* pargs_in = (oe_syscall_ftruncate_ocall_args_t*)input_buffer;
    oe_syscall_ftruncate_ocall_args_t* pargs_out = (oe_syscall_ftruncate_ocall_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = oe_syscall_ftruncate_ocall(
        pargs_in->fd,
        pargs_in->length);
    ...
    size_t* output_bytes_written)
{
    ...
    /* In-out parameters are copied to output buffer. */
    if (pargs_in->addr)
        OE_SET_OUT_POINTER(addr, pargs_in->addrlen_in, struct oe_sockaddr*);
    ...
    size_t* output_bytes_written)
{
    ...
    if (pargs_in->src_addr)
        OE_SET_OUT_POINTER(src_addr, pargs_in->addrlen_in, struct oe_sockaddr*);
    if (pargs_in->addrlen_out)
        OE_SET_OUT_POINTER(addrlen_out, ((size_t)1 * sizeof(oe_socklen_t)), oe_socklen_t*);
