...
enum
{
    helloworld_fcn_id_enclave_https = 0,
...
oe_result_t helloworld_enclave_https(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    enclave_https_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    OE_ADD_SIZE(_input_buffer_size, sizeof(enclave_https_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(enclave_https_args_t));
    /* There were no corresponding parameters. */
    ...
    _pargs_in = (enclave_https_args_t*)_input_buffer;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             __helloworld_ecall_info_table[helloworld_fcn_id_enclave_https].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (enclave_https_args_t*)_output_buffer;
...
OE_WEAK_ALIAS(helloworld_enclave_https, enclave_https);
