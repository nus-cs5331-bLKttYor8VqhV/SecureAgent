...
static void ecall_enclave_https(
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    enclave_https_args_t* pargs_in = (enclave_https_args_t*)input_buffer;
    enclave_https_args_t* pargs_out = (enclave_https_args_t*)output_buffer;
...
oe_ecall_func_t __oe_ecalls_table[] = {
    (oe_ecall_func_t) ecall_enclave_https,
